...
const AccountMenu: FC = () => {
  ...
  return (
    <>
      ...
      <Menu>
        {!authState.activated && (
          <MenuItem disabled icon="warning-sign" text={t.components.AccountManager.account_not_activated} />
        )}
        ...
        <GlobalErrorBoundary>
          ...
          >
            <Tab
              ...
              panel={
                <LoginPanel onNavigateRegisterPanel={() => setActiveTab('register')} onComplete={() => onClose?.()} />
              }
            />
            <Tab
              id="register"
