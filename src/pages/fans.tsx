    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {users.length > 0 ? (
        ...
        isReachingEnd && (
          <NonIdealState
            icon="slash"
            title={t.pages.fans.empty_title}
            description={t.pages.fans.empty_description}
          />
        )
      )}
...
_FansPage.displayName = 'FansPage'

export const FansPage = _FansPage
